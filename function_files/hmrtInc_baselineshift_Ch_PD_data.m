function [tIncCh, tInc, SNR_Three_PD] = hmrtInc_baselineshift_Ch_PD_data(dod, t,PD_data)
...
fs = abs(1/(t(2)-t(1)));
for ww = 1:size(dod,2)
    clearvars -except ww tInc d ml fs t dod tMotion SD dodorg p iqr SNR_Thre SNR_Thre2 FrameSize_sec PD_data
    s1 =  dod(:,ww) ;
...
%save SNR_Thre
%"SNR_Thre_PD"+num2str(subjectN)+"_"+eventType+"_"+num2str(eventN)+"_TimeW"+time_window+""

%SNR_Thre_PD = SNR_Thre;
%save("SNR_Thre_PD"+num2str(PD_data.subjectN)+"_"+PD_data.eventType+"_"+num2str(PD_data.eventN)+"_TimeW"+PD_data.time_window+"","SNR_Thre_PD");

SNR_Three_PD =SNR_Thre;
