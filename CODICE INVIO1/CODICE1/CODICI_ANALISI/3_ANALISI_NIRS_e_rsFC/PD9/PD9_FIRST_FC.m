...
% PD 09 FIRST EUGLYCEMIA INTERVAL
...
data_path_nirs = fullfile(base_path,'CODICE','DEFINITIVO/','NIRS/','PD9');
...
load PD9_NIRS_first_eu_tot.mat 
...
% PD09 = 26+2 weeks --> 29 gestation weeks (since no head models is
% available under 29 weeks)
...
% Best 5' time window 
[d_best,t_best,C_thresh,tab_win_after_good,best_five] = nirs_best_window(first_synchro_result,d,t,rmch,spect_param,J_850,mesh_850_29w,f_disp,disp_single,disp_result);

% idx_man = 3;
% [d_best,t_best,C_thresh,tab_win_after_good,best_five] = nirs_best_window_man(first_synchro_result,d,t,rmch,spect_param,J_850,mesh_850_29w,f_disp,disp_single,disp_result,idx_man);
...
% save PD9_NIRS_best_first.mat t_best d_best d_best_good SD
% disp('Saving complete')

% load('PD9_NIRS_best_first.mat')
...
% save PD_9_FIRST_Wavelet.mat dodWavelet dodWavelet_good t_best
% disp('Save wavelet complete')
% load PD_9_FIRST_Wavelet.mat
...
save PD9_NIRS_preprocessed_BP_first.mat dodFilt dodFilt_good t_best SD 
disp('Saving complete')

% load('PD9_NIRS_preprocessed_BP_first.mat')
...
% load img_recon_PD9_first_eu.mat
...
% save PD_9_FIRST_rsFC.mat FC_struct ROI_table
% disp('rsFC saved')
% close all
