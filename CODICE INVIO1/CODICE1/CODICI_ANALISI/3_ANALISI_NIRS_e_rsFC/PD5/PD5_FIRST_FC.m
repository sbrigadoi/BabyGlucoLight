...
% PD 05 FIRST EUGLYCEMIA INTERVAL
...
th_power_1 = 0.01;   % ESCLUDO DUE CANALI CON BASELINE SHIFT
% th_power_1 = 0.5;
th_power_2 = 0.01;
...
data_path_nirs = fullfile(base_path,'CODICE','DEFINITIVO/','NIRS/','PD5');
...
load PD5_NIRS_first_eu_tot.mat 
...
% PD05 = 33+1 weeks --> 33 gestation weeks
...
save PD5_NIRS_best_first.mat t_best d_best d_best_good SD
disp('Saving complete')

% load('PD5_NIRS_best_first.mat')
...
save PD_5_FIRST_Wavelet.mat dodWavelet dodWavelet_good t_best
disp('Save wavelet complete')
% load PD_5_FIRST_Wavelet.mat
...
save PD5_NIRS_preprocessed_BP_first.mat dodFilt dodFilt_good t_best SD 
disp('Saving complete')

% load('PD5_NIRS_preprocessed_BP_first.mat')
...
% load img_recon_PD5_first_eu.mat
...
save PD_5_FIRST_rsFC.mat FC_struct ROI_table
disp('rsFC saved')
