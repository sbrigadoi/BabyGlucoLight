...
data_path_nirs = fullfile(base_path,'DATI','NIRS','PD3');
function_path  = fullfile(base_path,'CODICE','FUNCTION');
...
%tmp = fullfile(data_path_nirs,'*PD3 bis 19*.nirs'); %last euc

tmp = fullfile(data_path_nirs,'*PD3 PM 19.3*.nirs'); %first euc
...
% In order to get the length of the last acqusition file it is necessary to
% load it
%load('PD3 bis 19.03.03 Fri 10 Apr 2020 47.nirs','-mat'); %last euc wind

load('PD3 PM 19.34.37 Tue 07 Apr 2020 82.nirs','-mat'); %first euc window
...
if date_start_sincro < date_end_first 
    diff_Nirs_sincro = date_start_sincro - date_start_first;
    date_start_Nirs = date_start_first;
    %dataset_name = 'PD3 bis 19.03.03 Fri 10 Apr 2020 %d.nirs'; %last
    dataset_name = 'PD3 PM 19.34.37 Tue 07 Apr 2020 %d.nirs'; %first
end
...
if date_start_sincro_last < date_end_first 
    ...
    date_start_Nirs = date_start_first;
    dataset_name = 'PD3 bis 19.03.03 Fri 10 Apr 2020 %d.nirs';
end
...
% Save of the results (!!Be carefull when uncomment the next line!!)
%save PD3_synchro_result_last_eu.mat synchro_result

save PD3_synchro_result_first_eu.mat synchro_result
...
%NIRS FILE INFO FOR SINCRO FROM 07-Apr-2020 23:25:00 /TO/ 10-Apr-2020 16:20:00
 
%START
%Name   : PD3 PM 19.34.37 Tue 07 Apr 2020 4.nirs
%Time   : 07-Apr-2020 22:54:37
%Sample : 18226
 
%END
%Name   : PD3 PM 19.34.37 Tue 07 Apr 2020 82.nirs
%Time   : 10-Apr-2020 15:54:45
%Sample : 15148

% LAST EUGLYCEMIA INTERVAL SYNCHRONIZATION
% 
% NIRS FILE INFO FOR SINCRO FROM 11-Apr-2020 09:00:00 /TO/ 12-Apr-2020 10:40:00
% 
% START
% Name   : PD3 bis 19.03.03 Fri 10 Apr 2020 16.nirs
% Time   : 11-Apr-2020 08:23:04
% Sample : 22154
% 
% END
% Name   : PD3 bis 19.03.03 Fri 10 Apr 2020 47.nirs
% Time   : 12-Apr-2020 10:13:07
% Sample : 16123

% Da cambiare per altri PAX
% SPECIFIC FOR PD3
idx_file_Nirs_start_sincro_first = 4;
idx_file_Nirs_end_sincro_first = 82;

%idx_file_Nirs_start_sincro_last = 16;
%idx_file_Nirs_end_sincro_last = 47;

% % First EU
if date_start_first_eu < date_end_first 
    %dataset_name_first = 'PD3 bis 19.03.03 Fri 10 Apr 2020 %d.nirs'; %last euc
    dataset_name_first = 'PD3 PM 19.34.37 Tue 07 Apr 2020 %d.nirs'; %first euc

end

% Last Eu
% if date_start_last_eu < date_end_first 
%     dataset_name_last = 'PD3 bis 19.03.03 Fri 10 Apr 2020 %d.nirs';
% end
...
first_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD3/','PD3_NIRS_DATA_EU/','PD3_NIRS_first_eu_tot.mat');
...
last_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD3/','PD3_NIRS_DATA_EU/','PD3_NIRS_last_eu_tot.mat');
