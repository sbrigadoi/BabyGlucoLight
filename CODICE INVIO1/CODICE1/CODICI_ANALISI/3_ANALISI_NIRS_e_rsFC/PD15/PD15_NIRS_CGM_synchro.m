...
data_path_nirs = fullfile('E:\DATI\NIRS\PD15');
...
tmp = fullfile(data_path_nirs,'*PD15 16*.nirs');
info_first_dataset = dir(tmp);
tmp = fullfile(data_path_nirs,'*PD15 bis*.nirs');
...
% load it
load('PD15 16.46.30 Wed 15 Jul 2020 19.nirs','-mat');
n_last = length(t);
...
% In order to get the length of the last acqusition file it is necessary to
% load it
load('PD15 bis 09.28.52 Thu 16 Jul 2020 117.nirs','-mat');
n_last = length(t);
...
if date_start_sincro < date_end_first 
    ...
    dataset_name = 'PD15 16.46.30 Wed 15 Jul 2020 %d.nirs';
else
    diff_Nirs_sincro = date_start_sincro - date_start_second;
    date_start_Nirs = date_start_second;
    dataset_name = 'PD15 bis 09.28.52 Thu 16 Jul 2020 %d.nirs';
end
...
% save PD15_synchro_result.mat synchro_result
...
idx_file_Nirs_start_sincro_last = 90;
idx_file_Nirs_end_sincro_last = 90;

% First EU
if date_start_first_eu < date_end_first 
    dataset_name_first = 'PD15 16.46.30 Wed 15 Jul 2020 %d.nirs';
else
    dataset_name_first = 'PD15 bis 09.28.52 Thu 16 Jul 2020 %d.nirs';
end

% Last Eu
if date_start_last_eu < date_end_first 
    dataset_name_last = 'PD15 16.46.30 Wed 15 Jul 2020 %d.nirs';
else
    dataset_name_last = 'PD15 bis 09.28.52 Thu 16 Jul 2020 %d.nirs';
end
...
% 
% 
% fold_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD15/');
% mkdir(fold_path,'PD15_NIRS_DATA_EU/');
% 
% to_save = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD15/','PD15_NIRS_DATA_EU/','PD15_NIRS_first_eu_tot.mat');
...
% s = s_tot;
% 
% last_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD15/','PD15_NIRS_DATA_EU/','PD15_NIRS_last_eu_tot.mat');
