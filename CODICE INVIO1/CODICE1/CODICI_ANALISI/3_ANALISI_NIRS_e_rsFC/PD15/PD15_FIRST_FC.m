...
% PD 15 FIRST EUGLYCEMIA INTERVAL
...
% % SPECTRAL ANALYSIS PARAMETERS : DEFINTIVE
th_power_1 = 0.01;
th_power_2 = 0.01;
...
addpath(dati_ext_disc)
addpath(head_model_ext_disc)
...
load PD15_NIRS_first_eu_tot.mat
...
% PD15 = 32+6 --> 33 gestation weeks
load J_735_33w.mat
load mesh_735_33w.mat

load J_850_33w.mat
load mesh_850_33w.mat
...
% Best 5' time window 
[d_best,t_best,C_thresh,tab_win_after_good,best_five] = nirs_best_window(first_synchro_result,d,t,rmch,spect_param,J_850,mesh_850_33w,f_disp,disp_single,disp_result);
...
% save PD15_NIRS_best_first.mat t_best d_best d_best_good SD
% disp('Saving complete')

% load('PD15_NIRS_best_first.mat')
...
figure()
subplot(2,1,1)
plot(t_new,dodConv_good(:,n_ch+1:end))
...
subplot(2,1,2)
plot(t_new,dodWavelet_good(:,nCh+1:end))
...
% save PD_15_FIRST_Wavelet.mat dodWavelet dodWavelet_good t_best
% disp('Save wavelet complete')
% load PD_15_FIRST_Wavelet.mat
...
% figure()
% plot(t,dodConvGood(:,:))
% title(['DOD Good Channel MA Identification BOTH Wavelength'])
% hold on;
% for i = 1:length(tInc)
%     if tInc(i) == 0 
...
% save PD15_NIRS_preprocessed_BP_first.mat dodFilt dodFilt_good t_best SD 
% disp('Saving complete')

% load('PD15_NIRS_preprocessed_BP_first.mat')
...
addpath('E:\DATI\4DNeonatalHeadModel\MODEL\33-weeks')
load('AllMeshes_33weeks.mshs','-mat')

% Load 'vol2gm' matrix, it maps values from volumetric to GM surface 
addpath 'E:\DATI\4DNeonatalHeadModel\JACOBIAN_AND_MESH\33_WEEKS_JACOBIAN_AND_MESH'
load vol2gm_33w.mat
...
% save PD_15_FIRST_rsFC_prova.mat FC_struct ROI_table
% disp('rsFC saved')
