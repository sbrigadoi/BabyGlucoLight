...
data_path_nirs = fullfile('E:\DATI\NIRS\PD19\');
...
tmp = fullfile(data_path_nirs,'*PD19 bis 17*.nirs');
...
% load it
load('PD19 bis 17.07.58 Sat 19 Sep 2020 76.nirs','-mat');
n_last = length(t);
...
if date_start_sincro < date_end_first 
    ...
    dataset_name = 'PD19 bis 17.07.58 Sat 19 Sep 2020 %d.nirs';
end
...
% Si calcola l'indice di inizio sincronizzazione all'interno del file NIRS 
% contentenete la data di inizio sincronizzazione che nel PD19 corrisponde 
% alla data del primo campione CGM valido () 
...
% Si calcola l'indice di fine sincronizzazione all'interno del file NIRS 
% contentenete la data di fine sincronizzazione che nel PD19 corrisponde 
...
% Si calcola l'indice di fine sincronizzazione all'interno del file NIRS 
% contentenete la data di fine sincronizzazione che nel PD corrisponde 
% alla data dell'ultimo campione CGM valido e contenuto contemporaneamente
% in un file NIRS 
...
% to_save_PC = fullfile('C:\Users\giaco\OneDrive\Desktop\TESI MAGISTRALE\CODICE\DEFINITIVO\NIRS\PD19','PD19_synchro_result.mat');
% save (to_save_PC,'synchro_result');
...
idx_file_Nirs_end_sincro_first = 9;

idx_file_Nirs_start_sincro_last = 60;
idx_file_Nirs_end_sincro_last = 62;

% First EU
if date_start_first_eu < date_end_first 
    dataset_name_first = 'PD19 bis 17.07.58 Sat 19 Sep 2020 %d.nirs';
end

% Last Eu
if date_start_last_eu < date_end_first 
    dataset_name_last = 'PD19 bis 17.07.58 Sat 19 Sep 2020 %d.nirs';
end
...
% s = s_tot;
% 
% last_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD19/','PD19_NIRS_DATA_EU/','PD19_NIRS_last_eu_tot.mat');
