...
data_path_nirs = fullfile('E:\DATI\NIRS\PD11');
...
tmp = fullfile(data_path_nirs,'*PD11 17*.nirs');
...
% load it
load('PD11 17.13.08 Thu 28 May 2020 30.nirs','-mat');
n_last = length(t);
...
f_disp = 0; % NO display Command Window results
...
if date_start_sincro < date_end_first 
    ...
    dataset_name = 'PD11 17.13.08 Thu 28 May 2020 %d.nirs';
end
...
% save PD11_synchro_result.mat synchro_result
...
idx_file_Nirs_end_sincro_first = 8;

idx_file_Nirs_start_sincro_last = 19;
idx_file_Nirs_end_sincro_last = 28;

% First EU
if date_start_first_eu < date_end_first 
    dataset_name_first = 'PD11 17.13.08 Thu 28 May 2020 %d.nirs';
end

% Last Eu
if date_start_last_eu < date_end_first 
    dataset_name_last = 'PD11 17.13.08 Thu 28 May 2020 %d.nirs';
end
...
% fold_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD11/');
% mkdir(fold_path,'PD11_NIRS_DATA_EU/');
% 
% to_save = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD11/','PD11_NIRS_DATA_EU/','PD11_NIRS_first_eu_tot.mat');
...
% s = s_tot;
% 
% last_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD11/','PD11_NIRS_DATA_EU/','PD11_NIRS_last_eu_tot.mat');
