...
% PD 11 FIRST EUGLYCEMIA INTERVAL
...
data_path_nirs = fullfile(base_path,'CODICE','DEFINITIVO/','NIRS/','PD11');
...
load PD11_NIRS_first_eu_tot.mat 
...
% PD11 = 31+2 weeks --> 31 gestation weeks
...
% save PD11_NIRS_best_first.mat t_best d_best d_best_good SD
% disp('Saving complete')

% load('PD11_NIRS_best_first.mat')
...
% save PD_11_FIRST_Wavelet.mat dodWavelet dodWavelet_good t_best
% disp('Save wavelet complete')
% load PD_11_FIRST_Wavelet.mat
...
% save PD11_NIRS_preprocessed_BP_first.mat dodFilt dodFilt_good t_best SD 
% disp('Saving complete')

% load('PD11_NIRS_preprocessed_BP_first.mat')
...
% load img_recon_PD11_first_eu.mat
...
% save PD_11_FIRST_rsFC.mat FC_struct ROI_table
% disp('rsFC saved')
