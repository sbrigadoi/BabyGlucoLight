...
% PD 11 LAST EUGLYCEMIA INTERVAL
...
load PD11_NIRS_last_eu_tot.mat 
...
% Best 5' time window 
idx_man = 4;
[d_best,t_best,C_thresh,tab_win_after_good,best_five] = nirs_best_window_man(last_synchro_result,d,t,rmch,spect_param,J_850,mesh_850_31w,f_disp,disp_single,disp_result,idx_man);
...
% save PD11_NIRS_best_last.mat t_best d_best d_best_good SD
% disp('Saving complete')


% load('PD11_NIRS_best_last.mat')
...
% save PD_11_LAST_Wavelet.mat dodWavelet dodWavelet_good t_best
% disp('Save wavelet complete')
% load PD_11_LAST_Wavelet.mat
...
% save PD11_NIRS_preprocessed_BP_last.mat dodFilt dodFilt_good t_best SD 
% disp('Saving complete')

% load('PD11_NIRS_preprocessed_BP_last.mat')
...
% load img_recon_PD11_last_eu.mat
...
% save PD_11_LAST_rsFC.mat FC_struct ROI_table
% disp('rsFC saved')
