...
data_path_nirs = fullfile('E:\DATI\NIRS\PD8\');
...
tmp = fullfile(data_path_nirs,'*PD8 16*.nirs');
...
% load it
load('PD8 16.21.59 Sat 02 May 2020 115.nirs','-mat');
n_last = length(t);
...
if date_start_sincro < date_end_first 
    ...
    dataset_name = 'PD8 16.21.59 Sat 02 May 2020 %d.nirs';
end
...
% save PD8_synchro_result.mat synchro_result
...
if date_start_first_eu < date_end_first 
    dataset_name_first = 'PD8 16.21.59 Sat 02 May 2020 %d.nirs';
end

% Last Eu
if date_start_last_eu < date_end_first 
    dataset_name_last = 'PD8 16.21.59 Sat 02 May 2020 %d.nirs';
end
...
% s = s_tot;
% 
% last_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD8/','PD8_NIRS_DATA_EU/','PD8_NIRS_last_eu_tot.mat');
