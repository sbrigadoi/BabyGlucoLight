...
% PD 09 LAST EUGLYCEMIA INTERVAL

% 22/07 Ci sono 50 secondi di tracciato dove probabilmente il bambino si è
% mosso troppo o è stato preso in braccio, un canale ha SNR altissimo.
% Valutare altre finestre
...
load PD25_synchro_result_last_eu.mat
...
load PD25_NIRS_last_eu_tot.mat 
...
% Best 5' time window 
 [d_best,t_best,C_thresh,tab_win_after_good,best_five] = nirs_best_window(last_synchro_result,d,t,rmch,spect_param,J_850,mesh_850_31w,f_disp,disp_single,disp_result);


%idx_man = 18;
%[d_best,t_best,C_thresh,tab_win_after_good,best_five] = nirs_best_window_man(last_synchro_result,d,t,rmch,spect_param,J_850,mesh_850_29w,f_disp,disp_single,disp_result,idx_man);
...
% % Save of the NIRS signal: ALL CHANNELS, bad channels inof are inside SD
 ...
 save PD25_NIRS_best_last.mat t_best d_best d_best_good SD
 disp('Saving complete')

 load('PD25_NIRS_best_last.mat')
...
% save PD_4_LAST_Wavelet.mat dodWavelet dodWavelet_good t_best
% disp('Save wavelet complete')
% load PD_4_LAST_Wavelet.mat
...
% save PD4_NIRS_preprocessed_BP_last.mat dodFilt dodFilt_good t_best SD 
% disp('Saving complete')

% load('PD4_NIRS_preprocessed_BP_last.mat')
...
% load img_recon_PD4_last_eu.mat
...
[ROI_table,ROI_active_table,tenTwenty,FC_struct] = rsFC(tenFive,gmSurfaceMesh,vol2gm,all_J,C_thresh,r_ROI,hbo,hbr,f_res);
 ...
 save PD_25_LAST_rsFC.mat FC_struct ROI_table
 disp('rsFC saved')
