...
% PD 47 LAST EUGLYCEMIA INTERVAL
...
load PD47_synchro_result_last_eu.mat
...
load PD47_NIRS_last_eu_tot.mat 
...
% PD47 = 30+4 weeks --> 31 gestation weeks
...
% A mano togliamo il 55
% removeChSpect(55) = 0;
% removeChSpect(55+64) = 0;
% removeChSpect([10,12,13]) = 0;
% removeChSpect([10+64,12+64,13+64]) = 0;
...
% save P47_NIRS_best_last.mat t_best d_best d_best_good SD
% disp('Saving complete')

% load('PD47_NIRS_best_last.mat')
...
% save PD_47_LAST_Wavelet.mat dodWavelet dodWavelet_good t_best
% disp('Save wavelet complete')
% load PD_47_LAST_Wavelet.mat
...
% save PD47_NIRS_preprocessed_BP_last.mat dodFilt dodFilt_good t_best SD 
% disp('Saving complete')

% load('PD47_NIRS_preprocessed_BP_last.mat')
...
% load img_recon_PD47_last_eu.mat
...
% save PD_47_LAST_rsFC.mat FC_struct ROI_table
% disp('rsFC saved')
