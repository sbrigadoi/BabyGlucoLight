...
% PD 47 FIRST EUGLYCEMIA INTERVAL
...
data_path_nirs = fullfile(base_path,'CODICE','DEFINITIVO/','NIRS/','PD47');
...
% PD09 = 30+4 weeks --> 31 gestation weeks
...
load PD47_synchro_result_1.mat
...
load PD47_NIRS_first_eu_tot_1.mat
...
% Load of the synchronization results in order to display usefull
% information about the start and end time of the best 5' time window
load PD47_synchro_result_2.mat
...
% Load of the NIRS data for first Euglycemia interval
load PD47_NIRS_first_eu_tot_2.mat
...
%%
% THE BEST 5' TIME WINDOW IS IN THE FIRST DATASET
...
% save PD47_NIRS_best_first.mat t_best d_best d_best_good SD
% disp('Saving complete')

% load('PD47_NIRS_best_first.mat')
...
% save PD_47_FIRST_Wavelet.mat dodWavelet dodWavelet_good t_best
% disp('Save wavelet complete')
% load PD_47_FIRST_Wavelet.mat
...
% save PD47_NIRS_preprocessed_BP_first.mat dodFilt dodFilt_good t_best SD 
% disp('Saving complete')

% load('PD47_NIRS_preprocessed_BP_first.mat')
...
% load img_recon_PD47_first_eu.mat
...
% save PD_47_FIRST_rsFC.mat FC_struct ROI_table
% disp('rsFC saved')
