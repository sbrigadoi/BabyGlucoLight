...
% CASO SPECIALE: Ha 3 database, siccome non ho una funzione che vada bene
% per più di 2 dataset, per questo paziente è stata fatta la
% sincronizzazione a mano.

% TOGLIERE I COMMENTI RELATIVI ALL'INTERVALLO DI EUGLICEMIA CHE SI VUOLE
% ANALIZZARE

%% PRIMO INTERVALLO DI EUGLICEMIA
% close all
% clear all
% clc
% 
...
% data_path_nirs = fullfile('E:\DATI\NIRS\PD47');
...
% tmp = fullfile(data_path_nirs,'*PD47 17.24*.nirs');
...
% % load it
% load('PD47 17.24.03 Thu 08 Sep 2022 24.nirs','-mat');
% n_last = length(t);
% 
...
%     dataset_name = 'PD47 17.24.03 Thu 08 Sep 2022 %d.nirs';
% end
% 
...
% %                                                                           SPECIFIC FOR PD47
% idx_file_Nirs_start_sincro_first = 3;
% idx_file_Nirs_end_sincro_first = 24;
% 
...
%     dataset_name_first = 'PD47 17.24.03 Thu 08 Sep 2022 %d.nirs';
% end
% 
% a = 0;
...
% % s = s_tot;
% % 
% % fold_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD47/');
% % mkdir(fold_path,'PD47_NIRS_DATA_EU/');
% % 
% % to_save = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD47/','PD47_NIRS_DATA_EU/','PD47_NIRS_first_eu_tot_3.mat');
...
% % save PD11_synchro_result_1.mat synchro_result
...
% files. The command 'dir' extracts the informations of all files which
% contains inside the name the words passed as argument.
tmp = fullfile(data_path_nirs,'*PD47 19.57*.nirs');
info_first_dataset = dir(tmp);
n_dataset_1 = length(info_first_dataset);
...
% In order to get the length of the last acqusition file it is necessary to
% load it
load('PD47 19.57.54 Sat 10 Sep 2022 78.nirs','-mat');
n_last = length(t);
...
if date_start_sincro < date_end_first 
    diff_Nirs_sincro = date_start_sincro - date_start_first;
    date_start_Nirs = date_start_first;
    dataset_name = 'PD47 19.57.54 Sat 10 Sep 2022 %d.nirs';
end
...
% Save of the results (!!Be carefull when uncomment the next line!!)
save PD47_synchro_result_last_eu.mat synchro_result
...
% SPECIFIC FOR PD47
% idx_file_Nirs_start_sincro_first = 3;
% idx_file_Nirs_end_sincro_first = 7;

idx_file_Nirs_start_sincro_last = 70;
idx_file_Nirs_end_sincro_last = 78;

% % First EU
% if date_start_first_eu < date_end_first 
%     dataset_name_first = 'PD47 19.57.54 Sat 10 Sep 2022 %d.nirs';
% end

% Last Eu
if date_start_last_eu < date_end_first 
    dataset_name_last = 'PD47 19.57.54 Sat 10 Sep 2022 %d.nirs';
end
...
% s = s_tot;
% 
% % fold_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD8/');
% % mkdir(fold_path,'PD8_NIRS_DATA_EU/');
% % 
% % to_save = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD8/','PD8_NIRS_DATA_EU/','PD8_NIRS_first_eu_tot.mat');
% % save (to_save, 'd','t','aux','s','SD')
...
% s = s_tot;
% 
% last_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD47/','PD47_NIRS_DATA_EU/','PD47_NIRS_last_eu_tot.mat');
