...
data_path_nirs = fullfile('E:\DATI\NIRS\PD14\');
...
tmp = fullfile(data_path_nirs,'*PD 14 16*');
...
% load it
load('PD 14 16.32.16 Mon 22 Jun 2020 136.nirs','-mat');
n_last = length(t);
...
if date_start_sincro < date_end_first 
    ...
    dataset_name = 'PD 14 16.32.16 Mon 22 Jun 2020 %d.nirs';
end
...
% contentenete la data di inizio sincronizzazione che nel PD corrisponde 
...
% to_save = fullfile(base_path,'CODICE\','DEFINITIVO\','NIRS\','PD14','PD14_synchro_result.mat');
...
% SPECIFIC FOR PD14
idx_file_Nirs_start_sincro_first = 33;
idx_file_Nirs_end_sincro_first = 34;

idx_file_Nirs_start_sincro_last = 121;
idx_file_Nirs_end_sincro_last = 125;

% First EU
if date_start_first_eu < date_end_first 
    dataset_name_first = 'PD 14 16.32.16 Mon 22 Jun 2020 %d.nirs';
end

% Last Eu
if date_start_last_eu < date_end_first 
    dataset_name_last = 'PD 14 16.32.16 Mon 22 Jun 2020 %d.nirs';
end
...
% mkdir(fold_path,'PD14_NIRS_DATA_EU/');
% 
% to_save = fullfile(data_path_nirs,'PD14_NIRS_DATA_EU/','PD14_NIRS_first_eu_tot.mat');
...
% s = s_tot;
% 
% last_path = fullfile(data_path_nirs,'PD14_NIRS_DATA_EU','PD14_NIRS_last_eu_tot.mat');
