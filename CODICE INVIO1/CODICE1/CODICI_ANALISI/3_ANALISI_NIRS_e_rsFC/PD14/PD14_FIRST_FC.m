...
% 08 AGOSTO: PRENDERE FINESTRA MIGLIORE ED ELIMINARE ROI CON NODI ATTIVI
% MENO DEL 1/3 DEI NODI TOTALI DELLA ROI IN ANALISI. IN QUESTO CASO SI
% HANNO 2 ROI ELIMINATE (NAN) CORRISPONDENTI A F3 E FZ. PER FAR CIO'
% PASSARE A rsFC LA MATRICE J CON SOLI GOOD CHANNELS. LA FINESTRA MIGLIORE
% E' TROVATA CON SNR90

% PD 14 FIRST EUGLYCEMIA INTERVAL
...
data_path_nirs = fullfile(base_path,'CODICE','DEFINITIVO/','NIRS/','PD14');
...
load PD14_NIRS_first_eu_tot.mat 
...
% PD14 = 29+5 weeks --> 30 gestation weeks

load J_780_30w.mat
load mesh_780_30w.mat
mesh_780_30w = mesh;

load J_850_30w.mat
load mesh_850_30w.mat
mesh_850_30w = mesh;
...
% Best 5' time window 
[d_best,t_best,C_thresh,tab_win_after_good,best_five] = nirs_best_window(first_synchro_result,d,t,rmch,spect_param,J_850,mesh_850_30w,f_disp,disp_single,disp_result);

% idx_man = 4;
% [d_best,t_best,C_thresh,tab_win_after_good,best_five] = nirs_best_window_man(first_synchro_result,d,t,rmch,spect_param,J_850,mesh_850_30w,f_disp,disp_single,disp_result,idx_man);
...
% save PD14_NIRS_best_first.mat t_best d_best d_best_good SD
% disp('Saving complete')

% load('PD14_NIRS_best_first.mat')
...
% save PD_14_FIRST_Wavelet.mat dodWavelet dodWavelet_good t_best
% disp('Save wavelet complete')
% load PD_14_FIRST_Wavelet.mat
...
% save PD14_NIRS_preprocessed_BP_first.mat dodFilt dodFilt_good t_best SD 
% disp('Saving complete')

% load('PD14_NIRS_preprocessed_BP_first.mat')
...
addpath('E:\DATI\4DNeonatalHeadModel\MODEL\30-weeks')
load('AllMeshes_30weeks.mshs','-mat')

% Load 'vol2gm' matrix, it maps values from volumetric to GM surface 
addpath 'E:\DATI\4DNeonatalHeadModel\JACOBIAN_AND_MESH\30_WEEKS_JACOBIAN_AND_MESH'
load vol2gm_30w.mat
...
% load img_recon_PD14_first_eu.mat
