...
% PD 14 LAST EUGLYCEMIA INTERVAL
...
load PD14_NIRS_last_eu_tot.mat 
...
% Best 5' time window 
[d_best,t_best,C_thresh,tab_win_after_good,best_five] = nirs_best_window(last_synchro_result,d,t,rmch,spect_param,J_850,mesh_850_30w,f_disp,disp_single,disp_result);
...
% save PD14_NIRS_best_last.mat t_best d_best d_best_good SD
% disp('Saving complete')

% load('PD14_NIRS_best_last.mat')
...
% 
% save PD_14_LAST_Wavelet.mat dodWavelet dodWavelet_good t_best
...
% save PD14_NIRS_preprocessed_BP_last.mat dodFilt dodFilt_good t_best SD
% disp('Saving complete')

% load('PD14_NIRS_preprocessed_BP_last.mat')
...
% load img_recon_PD14_last_eu.mat
...
% 
% save PD_14_LAST_rsFC.mat FC_struct ROI_table
% disp('rsFC saved')
% close all
