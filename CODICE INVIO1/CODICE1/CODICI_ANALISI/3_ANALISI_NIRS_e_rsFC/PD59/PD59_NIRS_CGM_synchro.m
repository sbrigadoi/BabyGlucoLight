...
data_path_nirs = fullfile(base_path,'DATI','NIRS','PD59');
function_path  = fullfile(base_path,'CODICE','FUNCTION');
...
% Save of the results (!!Be carefull when uncomment the next line!!)
save PD4_synchro_result_last_eu.mat synchro_result
...
idx_file_Nirs_start_sincro_last = 97;
idx_file_Nirs_end_sincro_last = 108;
...
if date_start_last_eu < date_end_first 
    dataset_name_last = 'PD4 18.16.25 Sun 12 Apr 2020 %d.nirs';
end
...
% s = s_tot;
% 
% last_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD4/','PD4_NIRS_DATA_EU/','PD4_NIRS_last_eu_tot.mat');
