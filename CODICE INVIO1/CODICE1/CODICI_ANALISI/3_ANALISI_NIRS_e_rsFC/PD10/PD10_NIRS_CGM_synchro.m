...
data_path_nirs = fullfile(base_path,'DATI','NIRS','PD10');
function_path  = fullfile(base_path,'CODICE','FUNCTION');
...
% files. The command 'dir' extracts the informations of all files which
% contains inside the name the words passed as argument.
tmp = fullfile(data_path_nirs,'*PD10 11.45.*.nirs');
info_first_dataset = dir(tmp);
n_dataset_1 = length(info_first_dataset);
...
% In order to get the length of the last acqusition file it is necessary to
% load it
load('PD10 11.45.26 Wed 13 May 2020 91.nirs','-mat');
n_last = length(t);
...
if date_start_sincro < date_end_first 
    diff_Nirs_sincro = date_start_sincro - date_start_first;
    date_start_Nirs = date_start_first;
    dataset_name = 'PD10 11.45.26 Wed 13 May 2020 %d.nirs';
end
...
%save PD10_synchro_result_first_eu.mat synchro_result
save PD10_synchro_result_last_eu.mat synchro_result
...
% 
% NIRS FILE INFO FOR SINCRO FROM 13-May-2020 12:09:00 /TO/ 14-May-2020 13:04:00
% 
% START
% Name   : PD10 11.45.26 Wed 13 May 2020 0.nirs
% Time   : 13-May-2020 11:45:26
% Sample : 14140
% 
% END
% Name   : PD10 11.45.26 Wed 13 May 2020 30.nirs
% Time   : 14-May-2020 12:45:29
% Sample : 11110

% LAST EUGLYCEMIA INTERVAL SYNCHRONIZATION
% 
% NIRS FILE INFO FOR SINCRO FROM 14-May-2020 23:29:00 /TO/ 15-May-2020 20:39:00
% 
% START
% Name   : PD10 11.45.26 Wed 13 May 2020 42.nirs
% Time   : 14-May-2020 22:45:30
% Sample : 26098
% 
% END
% Name   : PD10 11.45.26 Wed 13 May 2020 68.nirs
% Time   : 15-May-2020 20:25:32
% Sample : 8072

% Da cambiare per altri PAX
% SPECIFIC FOR PD10
idx_file_Nirs_start_sincro_first = 0;
idx_file_Nirs_end_sincro_first = 30;

idx_file_Nirs_start_sincro_last = 42;
idx_file_Nirs_end_sincro_last = 68;
...
% Last Eu
 if date_start_last_eu < date_end_first 
     dataset_name_last = 'PD10 11.45.26 Wed 13 May 2020 %d.nirs';
 end
...
first_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD10/','PD10_NIRS_DATA_EU/','PD10_NIRS_first_eu_tot.mat');
...
last_path = fullfile(base_path,'CODICE/','DEFINITIVO/','NIRS/','PD10/','PD10_NIRS_DATA_EU/','PD10_NIRS_last_eu_tot.mat');
