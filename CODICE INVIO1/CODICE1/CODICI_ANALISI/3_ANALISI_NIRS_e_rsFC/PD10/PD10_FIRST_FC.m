...
data_path_nirs = fullfile(base_path,'CODICE','DEFINITIVO/','3_ANALISI_NIRS_e_rsFC/','PD10');
...
load('PD10_synchro_result_first_eu.mat')
...
load PD10_NIRS_first_eu_tot.mat
...
SD;
save PD10_NIRS_best_first.mat t_best d_best d_best_good SD
disp('Saving complete')

load('PD10_NIRS_best_first.mat')
...
[ROI_table,ROI_active_table,tenTwenty,FC_struct] = rsFC(tenFive,gmSurfaceMesh,vol2gm,all_J,C_thresh,r_ROI,hbo,hbr,f_res);
 ...
 save PD_10_FIRST_rsFC.mat FC_struct ROI_table
 disp('rsFC saved')
